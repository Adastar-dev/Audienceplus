...
import { listerJuges, listerGreffiers } from '../../services/api/utilisateurs'
import { listerConversation, envoyerMessage } from '../../services/api/messages'
import { useAuth } from '../../context/AuthContext'
import { formatMessageDate } from '../../utils/formatMessageDate'

// Le procureur échange avec les autres acteurs du tribunal : juges et
// greffiers. On fusionne les deux listes dans un seul sélecteur de
...
export default function Messagerie() {
  ...
  useEffect(() => {
    Promise.all([listerJuges(), listerGreffiers()])
      .then(([juges, greffiers]) => {
        const liste = [
  ...
  return (
    <div>
      ...
      <p className="text-sm text-slate-600 mt-1">Conversation privée avec un juge ou un greffier.</p>

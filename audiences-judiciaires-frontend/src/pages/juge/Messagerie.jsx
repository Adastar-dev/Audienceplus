...
import { listerGreffiers, listerProcureurs } from '../../services/api/utilisateurs'
import { listerConversation, envoyerMessage } from '../../services/api/messages'
import { useAuth } from '../../context/AuthContext'
import { formatMessageDate } from '../../utils/formatMessageDate'

// Le juge échange avec les autres acteurs du tribunal : greffiers et
// procureurs. On fusionne les deux listes dans un seul sélecteur de
...
export default function Messagerie() {
  ...
  useEffect(() => {
    Promise.all([listerGreffiers(), listerProcureurs()])
      .then(([greffiers, procureurs]) => {
        const liste = [
  ...
  return (
    <div>
      ...
      <p className="text-sm text-slate-600 mt-1">Conversation privée avec un greffier ou un procureur.</p>
